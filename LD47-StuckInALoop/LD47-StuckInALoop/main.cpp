...
int main()
{
    sf::RenderWindow window(sf::VideoMode(1280, 720), "LD47 Stuck in a loop");
    ...
    while (window.isOpen())
    {
        ...
        while (window.pollEvent(event))
        {
            ...
            {
                if (event.type == sf::Event::KeyPressed && m_moveUp == false && m_isPlayerFreezed == false)
                {
                    m_moveUp = true;
                }
            ...
            {
                if (event.type == sf::Event::KeyPressed && m_moveLeft == false && m_isPlayerFreezed == false)
                {
                    m_moveLeft = true;
                }
            ...
            {
                if (event.type == sf::Event::KeyPressed && m_moveDown == false && m_isPlayerFreezed == false)
                {
                    m_moveDown = true;
                }
            ...
            {
                if (event.type == sf::Event::KeyPressed && m_moveRight == false && m_isPlayerFreezed == false)
                {
                    m_moveRight = true;
                }
